...
(om::defmethod! no-parallels ((mode t) (intervals list) (voices list) &optional (gracenotes? :include-gracenotes) (rule-type :true/false) (weight 1))
 :initvals '( :open '(0 7) (0 1) :include-gracenotes :true/false 1)
 :indoc '("mode" "intervals-list" "voices-list" "gracenotes?" "rule-type" "weight-number")
 :icon 01
                            ...
                            (let* ((pitch1a (first pitches1))
                              ...
                              (case mode
                                ...
                                (:open (if matchingInterval2? 
                                         ...
                                         T))))
                          T))))) ; end of lambda function and eval
   (map-pairwise #'(lambda (voice1 voice2)
     (ce::Rpitch-pitch 
     rule
     (list voice1 voice2)
     '(0)  ; Adjust this as needed for your timepoints requirement
     :all
     :pitch
     rule-type weight))
     voices)))
